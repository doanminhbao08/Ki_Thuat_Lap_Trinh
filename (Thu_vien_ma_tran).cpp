...
int main(){
	...
	thay doi '\' thanh '\\'
	*/
	file.open("C:\\Users\\Admin\\Documents\\Code\\Matrix_libary.txt"); 
	if(file.fail() == true){
		cout << "\nKhong ton tai file";	
	}
	double A[20][20];
	...
	while(nhu_cau == 1){	
		...
		nhu_cau = -1;
		while(nhu_cau != 0 && nhu_cau != 1){
			cout << "\nBan con muon tiep tuc su dung chuong trinh khong ? \nNeu co chon 1, neu khong chon 0\n";
			cin >> nhu_cau;
		}
	}
